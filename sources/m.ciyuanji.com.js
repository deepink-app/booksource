...
const search = (key) => {
  ...
  let response = GET(`https://m.ciyuanji.com/_next/data/BxA7X9sPakW1wVreBXPwb/search/list.json?params=${params}`)
...
const detail = (url) => {
  ...
  let response = GET(`https://m.ciyuanji.com/_next/data/BxA7X9sPakW1wVreBXPwb/bookDetails.json?params=${params}`)
